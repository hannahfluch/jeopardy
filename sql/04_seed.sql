...
insert into jq_category (category_name) values ('Datenbanken');
insert into jq_category (category_name) values ('PLSQL');
insert into jq_category (category_name) values ('Popkultur');
...
insert into jq_question (
  category_id, clue_text, option_a, option_b, option_c, option_d, correct_option, point_value, round_no
) values (
  1,
